...
/**
 * @file
 * GAMMA - Template for a 3 column panel layout.
 *
 ...
 */
?>
<div class="panel-gamma clearfix panel-display container-fluid <?php if(empty($content['right'])){ print "right-no-right-sidebar";} ?> <?php if(empty($content['left'])){ print "left-no-left-sidebar";} ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <?php if ($content['left'] || $content['middle'] || $content['right']): ?>
    <div class="row center-wrapper" id="center-wrapper">
      ...
      <?php if ($content['middle']): ?>
        <div class="panel-col-middle panel-panel col-md-4">
