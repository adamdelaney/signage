...
/**
 * @file
 * BETA-FLIPPED - Template for a reversed 2 column panel layout.
 *
 ...
 */
?>
<div class="panel-beta-flipped clearfix panel-display container-fluid <?php if(empty($content['right'])){ print "right-no-right-sidebar";} ?> <?php if(empty($content['left'])){ print "left-no-left-sidebar";} ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <?php if ($content['left'] || $content['right']): ?>
    <div class="row center-wrapper" id="center-wrapper">
      <?php if ($content['left']): ?>
        <div class="panel-col-left panel-panel col-md-4">
          <div class="inside"><?php print $content['left']; ?></div>
        </div>
      <?php endif; ?>

      <?php if ($content['right']): ?>
        <div class="panel-col-right panel-panel col-md-8">
